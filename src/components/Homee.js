...
export default function Homee() {
  return (
    <>
      ...
      <div className="p-5" style={{ background: "#454545" }}>
        <div className="row">
          <div className="col-md-4 col-lg-3 mb-4 col-sm-6">
            <div className="card">
              ...
              <div className="card-body">
                <h5 className="card-title">BMW x6</h5>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4 col-lg-3 mb-4 col-sm-6">
            <div className="card">
              ...
              />
              <div className="card-body">
                <h5 className="card-title">BMW i5</h5>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4 col-lg-3 mb-4 col-sm-6">
            <div className="card">
              <img
                src="https://imgd.aeplcdn.com/664x374/n/cw/ec/140591/new-x1-exterior-left-front-three-quarter.jpeg?isig=0&q=80"
                className="card-img-top"
                alt="Card 6"
                height="250px"
              />
          ...
          <div className="col-md-4 col-lg-3 mb-4 col-sm-6">
            <div className="card">
              ...
              />
              <div className="card-body">
                <h5 className="card-title">BMW X7</h5>
              </div>
            </div>
          </div>
        </div>
